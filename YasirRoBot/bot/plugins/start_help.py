...
async def start(b, m):
    ...
    if Var.UPDATES_CHANNEL:
        try:
            ...
            await StreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://telegra.ph/file/bd89ad2742e034603bbd4.jpg",
    ...
    if usr_cmd == "/start" or usr_cmd == "start⚡️":
        ...
        await m.reply_text(
            text=f"""
👋 Hai {m.from_user.mention}, aku adalah <b>Unlimited Movie Bot</b>. Bot yang boleh mengubah file Telegram menjadi direct link dan link streaming tanpa menunggu lama.\n
Hantarkan aku sebuah file atau video dan lihat keajaiban yang terjadi!
Klik /help untuk melihat info lengkapnya.\n
<b>🍃 Bot dibuat oleh :</b>@ownerimmanvpn
<b><u>PERINGATAN 🚸</u></b>
<b>Jangan Spam bot!!!.</b>""",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Owner", url=f"https://t.me/{Var.OWNER_USERNAME}"), InlineKeyboardButton("Channel IMMANVPN", url="https://t.me/+89rINA_6_IE3YjU1")]]),
        )
    elif m.text == "/start donasi" or m.text == "Donate":
        await m.reply_photo("https://telegra.ph/file/bd89ad2742e034603bbd4.jpg", caption="🌟 Jika kamu merasa bot ini sangat bermanfaat, kamu boleh donate dengan scan kode DuitNow yang tertera. Berapapun nilainya saya sangat berterima kasih..")
    else:
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton("💰 Donate ke Owner", url=f"https://t.me/{(await b.get_me()).username}?start=donasi")],
                ]
            ),
        )
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL:
        try:
            ...
            await bot.send_message(chat_id=message.chat.id, text="__Something went wrong. Contact Me__ [IMMANVPN](https://t.me/ownerimmanvpn).", disable_web_page_preview=True)
            return
    await message.reply_text(
        text=f"{message.from_user.mention} hantarkan aku sebuah file dan aku akan mengubahnya menjadi direct link dan stream link!\nJika kamu suka dengan bot ini, kamu boleh donate ke owner melalui:\n~ <b>DuitNow</b>: https://payment.tngdigital.com.my/sc/bDLnUWRbEn",
        disable_web_page_preview=True,
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🧑🏻‍💼 Owner", url="https://t.me/ownerimmanvpn")], [InlineKeyboardButton("📥 Donate", url="https://payment.tngdigital.com.my/sc/bDLnUWRbEn")]]),
    )
